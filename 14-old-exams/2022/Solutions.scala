...
object SizedLists: 
   ...
   * called on a list containing at least three elements. */
   ...
   //Vores S inde i Inc[Inc[Inc[S]]]], er den som sørger for at det er ATLEAST 3 elements, og ikke præcis 3 elements.
  ...
  // matching (but not in the other case), and I am somewhat impressed that
