...
object PrimesAndLaziness:
  ...
  def primesApart(n: Int): LazyList[(Int, Int)] = 
    ...
    val consecutivePrimePairs: LazyList[(Int, Int)] = primes.zip(primesMinusFirstHead)
...
object SizedLists: 
  ...
  def third[A, S](l: SizedList[A, Inc[Inc[Inc[S]]]]): A = l match
    case Cons(_, Cons(_, Cons(hd, _))) => hd


  /* Q9. (10%) Write a function 't@@hird' that given a sized list of `A`s returns
...
```
dotty.tools.dotc.core.Types$VariantTraversal.stopBecauseStaticOrLocal(Types.scala:5487)
